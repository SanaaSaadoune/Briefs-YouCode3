...
if(!defined('ABSPATH'))
{
    ...
    function wphw_opt(){
        ...
        $poweredtxt = $_POST['footerpowered'];
        global $chk;
        ...
        if( get_option('powered') != trim($poweredtxt)){
          $chk1 = update_option( 'powered', trim($poweredtxt));
        }
    }
?>
<div class="wrap">
    ...
    <div class="postbox">
      ...
      <form method="post" action="">
        ...
        <tr>
            ...
            <td><input type="text" name="footerpowered" 
            value="<?php echo get_option('powered');?>" style="width:350px;" /></td>
                      </tr>
                      <tr>
